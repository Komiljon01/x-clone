    ...
    <div className="flex h-screen items-center justify-between p-8">
      <div className="hidden w-1/2 items-center justify-center lg:flex">
        <svg
          ...
          fill="white"
        >
          <path d="M18.244 2H21.25L14.06 10.304L22.5 22H15.93L10.84 15.288L5.062 22H2.056L9.836 13.016L1.75 2H8.568L13.2 8.096L18.244 2ZM17.09 19.664H18.92L7.07 4.216H5.11L17.09 19.664Z" />
        </svg>
      </div>
      <div className="flex w-full flex-col gap-4 lg:w-1/2">
        ...
        <SignUp.Root>
          <SignUp.Step name="start" className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Clerk.Field name="username" className="flex flex-col gap-2">
                <Clerk.Input
                  className="w-72 rounded-full bg-white px-6 py-2 text-black placeholder:text-sm"
          ...
          <SignUp.Step name="continue" className="flex flex-col gap-4">
            ...
            <SignUp.Action
              submit
              className="text-iconBlue w-72 cursor-pointer text-center underline"
            >
              Continue
            </SignUp.Action>
          </SignUp.Step>
          <SignUp.Step name="verifications">
            <SignUp.Strategy name="email_code">
              <h1 className="mb-2 text-sm">Check your e-mail</h1>
              ...
              <SignUp.Action
                submit
                className="text-iconBlue mt-2 cursor-pointer text-sm underline"
              >
                Verify
              </SignUp.Action>
            </SignUp.Strategy>
          ...
          <div className="flex w-72 items-center gap-4">
            <div className="bg-borderGray h-px flex-grow"></div>
            <span className="text-textGrayLight">or</span>
            <div className="bg-borderGray h-px flex-grow"></div>
          </div>
          <Link
            href="/sign-in"
            className="bg-iconBlue w-72 rounded-full p-2 text-center font-bold text-white"
          >
