      ...
      <div className="flex w-full flex-col gap-4 lg:w-1/2">
        ...
        <SignIn.Root>
          ...
          <SignIn.Step name="start">
            <Clerk.Field name="identifier" className="flex flex-col gap-2">
              <Clerk.Input
                ...
                className="w-72 rounded-full px-6 py-2 text-black placeholder:text-sm bg-white"
              />
              <Clerk.FieldError className="text-sm text-red-300" />
            </Clerk.Field>
            <SignIn.Action
              submit
              className="text-iconBlue mt-2 w-72 text-center text-sm underline"
            >
              Continue
            </SignIn.Action>
          </SignIn.Step>
            ...
            <SignIn.Strategy name="password">
              ...
              <div className="flex flex-col gap-2">
                ...
                <SignIn.Action
                  ...
                  className="mt-2 w-72 text-center text-sm underline"
                >
                  Forgot Password?
                </SignIn.Action>
              </div>
          ...
          <SignIn.Step
            ...
            className="flex w-72 justify-between text-sm"
          >
